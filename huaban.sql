...
Source Database       : huaban

Target Server Type    : MYSQL
Target Server Version : 50540
File Encoding         : 65001

Date: 2017-10-09 14:26:37
*/
...
CREATE TABLE `classify` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='分类表（栏目表）';

-- ----------------------------
-- Records of classify
-- ----------------------------
INSERT INTO `classify` VALUES ('1', '草莓', 'images/icon1.jpg', '草莓不好吃');
INSERT INTO `classify` VALUES ('2', '派对装饰', 'images/icon2.jpg', '派对不能装饰');
INSERT INTO `classify` VALUES ('3', '雪', 'images/icon3.jpg', '结婚不吃蛋糕');
INSERT INTO `classify` VALUES ('4', '美食', 'images/icon4.jpg', 'lomo我不喜欢');
INSERT INTO `classify` VALUES ('5', '书架', 'images/icon5.jpg', '日系好恶心');
INSERT INTO `classify` VALUES ('6', '彩虹色', 'images/icon6.jpg', '牛奶奶牛');
INSERT INTO `classify` VALUES ('7', '人体艺术', 'images/icon7.jpg', '。。。。。。。。。');
...
INSERT INTO `collection` VALUES ('80', '17', '8');
INSERT INTO `collection` VALUES ('81', '42', '5');
INSERT INTO `collection` VALUES ('83', '43', '7');
...
CREATE TABLE `comment` (
  ...
  `conent` varchar(50) NOT NULL COMMENT '评论内容',
...
INSERT INTO `comment` VALUES ('10', '1', '1', '1231231231211111111', '1498918083', '0');
...
INSERT INTO `comment` VALUES ('68', '42', '5', '					\n小白兔，白又白	', '1501810745', '0');
INSERT INTO `comment` VALUES ('69', '42', '5', '大白兔白又白', '1501811223', '0');
INSERT INTO `comment` VALUES ('70', '42', '5', '小兔子啊小兔子啊', '1501811236', '0');
INSERT INTO `comment` VALUES ('71', '42', '5', '大兔子啊啊大团 阿呆', '1501811247', '0');
...
-- Records of image
-- ----------------------------
INSERT INTO `image` VALUES ('1', 'images/img1.jpg', '123123', '1499235806', '1', '0', '54', '2', '笑靥如花的你');
INSERT INTO `image` VALUES ('2', 'images/cont/zg.jpg', '看起来不错', '1499235006', '1', '0', '92', '3', '当下视觉||中餐摄影');
INSERT INTO `image` VALUES ('3', 'images/cont/rixi.png', '一见钟情<br/>不是看了一眼<br/>就喜欢上了你<br/>而是在一眼之后<br/>就再也不曾忘记', '1499235206', '1', '0', '221', '1', '日系写真');
INSERT INTO `image` VALUES ('4', 'images/cont/88.jpg', '', '1499235306', '1', '0', '25', '2', '猴哥MS原创&插画');
INSERT INTO `image` VALUES ('5', 'images/cont/89.png', '', '1499235406', '1', '0', '132', '3', '《纪念碑谷》官方海报');
INSERT INTO `image` VALUES ('6', 'images/cont/90.png', '', '1499235706', '1', '0', '62', '1', '排版精选');
INSERT INTO `image` VALUES ('7', 'images/cont/234.png', '草莓不新鲜啊', '1499235906', '8', '1', '14', '0', '草莓');
INSERT INTO `image` VALUES ('8', 'images/cont/245.png', '为什么喜欢草莓', '1498838400', '1', '1', '3', '0', '草莓1');
INSERT INTO `image` VALUES ('9', 'images/cont/246.png', '喜欢草莓的原因', '1498752000', '1', '1', '1', '0', '草莓2');
INSERT INTO `image` VALUES ('10', 'images/cont/247.png', '以前不爱吃草莓的我现在也爱上了吃', '1498838400', '8', '1', '0', '0', '草莓3');
INSERT INTO `image` VALUES ('11', 'images/cont/248.png', '草莓也是一种营养佳品', '1499184000', '1', '1', '1', '0', '草莓4');
...
INSERT INTO `image` VALUES ('14', 'images/cont/251.png', '草莓像是精心挑选的，每个都差不多一样大小', '1499184000', '1', '1', '1', '0', '草莓7');
...
INSERT INTO `image` VALUES ('20', 'images/cont/262.png', '', '1498838400', '1', '2', '6', '0', null);
...
CREATE TABLE `user` (
  ...
  `H_portrait` varchar(250) NOT NULL COMMENT '头像',
...
INSERT INTO `user` VALUES ('40', 'adminadmin', 'a66abb5684c45962d887564f08346e8d', '', null, '', null, '', null);
INSERT INTO `user` VALUES ('41', 'huabanwang', '847ae1b5afecfc0f1013b67088afaafb', '', null, '', null, '', null);
INSERT INTO `user` VALUES ('42', 'huaban', 'a81fe1e181fa02c6086b7e46925a593d', './uploads/201708031737317174677407e5d3a23780a5800739452be20360f589a7dda-nbz4us_sq320.jpg', '男', '河北省保定市', null, '阿德萨撒旦法撒旦法', '16782323232');
INSERT INTO `user` VALUES ('43', 'huabanwang1', '0f9c60818679257412780b892f26fd4e', '', null, '', null, '', null);
